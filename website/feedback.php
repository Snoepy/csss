...
<head>
	...
	<title>C.S.S.S | Get Feedback</title>
</head>

<header>
	<ul>
		<li class="header_button left"><a href="home">HOME</a></li>
		<li class="header_button left active"><a href="get-feedback">GIVE FEEDBACK</a></li>
...
<body class="body">
	<div class="wrapper">
		<h1 style="margin-bottom: 5px;">GET FEEDBACK | Created, Shared and Sold by Society</h1>
		<div class="concept">C.S.S.S is a concept from SNOEPY Productions <sup style="font-size: 8px;">TM</sup></div>
		<p>Welcom to the C.S.S.S. If you are a artist looking for a opportunity to get some feedback from pros in your branche, or to sell your work you are in the right place. Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Donec quam felis, ultricies nec, pellentesque eu, pretium quis, sem. Nulla consequat massa quis enim. Donec pede justo, fringilla vel, aliquet nec, vulputate eget, arcu. In enim justo, rhoncus ut, imperdiet a, venenatis vitae, justo. Nullam dictum felis eu pede mollis pretium. Integer tincidunt. Cras dapibus. Vivamus elementum semper nisi. Aenean vulputate eleifend tellus. Aenean leo ligula, porttitor eu, consequat vitae, eleifend ac, enim. Aliquam lorem ante, dapibus in, viverra quis, feugiat a, tellus. Phasellus viverra nulla ut metus varius laoreet. Quisque rutrum. Aenean imperdiet. Etiam ultricies nisi vel augue. Curabitur ullamcorper ultricies nisi.</p>

		<div class="photos">
			<h2 style="width: 100%;">GIVE SOME FEEDBACK TO OTHER GREAT ARTISTS OUT THERE</h2>
			<div class="column">
				<div class="photobox">
					<div class="image">
						...
						<a class="button" style="margin: 0;" href="http://localhost/PHP/csss/shop/index.php">GIVE FEEDBACK</a>
						<a href="/PHP/csss/website/profile"><div class="button" style="margin-bottom: 0;">VISIT THE ARTISTS PROFILE FOR MORE WORK</div></a>
					</div>
				</div>
				<div class="photobox">
					<div class="image">
